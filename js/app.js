...
function renderNewEmployee(employee) {
    const container = document.getElementById(employee.department);
    const divEl = document.createElement('div');
    divEl.classList.add("card");
    container.appendChild(divEl);
    const imgEl = document.createElement('img');
    ...
    const pEl = document.createElement('p');
    pEl.classList.add("p");
    pEl.textContent = `Name:  ${employee.fullName}`;
    divEl.appendChild(pEl);
    const pE2 = document.createElement('p');
    pE2.classList.add("p");
    pE2.textContent = `ID:  ${employee.employeeId}`;
    divEl.appendChild(pE2);
    const pE3 = document.createElement('p');
    pE3.classList.add("p");
    pE3.textContent = `Department:  ${employee.department}`;
    divEl.appendChild(pE3);
    const pE4 = document.createElement('p');
    pE4.classList.add("p");
    pE4.textContent = `Level:  ${employee.level}`;
    divEl.appendChild(pE4);
    const pE5 = document.createElement('p');
    pE5.classList.add("p");
    pE5.textContent = `Salary:  ${employee.salary}`;
    divEl.appendChild(pE5);
  }
